    ...
    >
      {items.map((app) => (
        <RevealItem key={app.title}>
          <TiltCard className="flex h-full flex-col items-center gap-3 rounded-2xl border border-border bg-card p-6 text-center transition-shadow duration-300 hover:border-gold/50 hover:shadow-lg">
